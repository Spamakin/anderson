...
\begin{lem}[{\cite{Kro82}}]
  ...
  Then the \emph{Kroncker substitution}
  \[
    x_i \mapsto w^{d^i}
  \]
...
\quest{TODO:\ Read and understand Kayal's work on annihilator polynomials and how it connects to HSGs}

\subsubsection{PIT vs Factoring}
